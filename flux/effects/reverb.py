...
class Reverb(AudioEffect):
    ...
    Classic reverb implemented using a short delay line to mimic environmental echoing.

    Parameters:
        Mix -- The ratio of original signal to reverb to use. [-]
    """
    name = 'Reverb'
    description = 'Reverb'
    ...
    def __init__(self):
        ...
        self.parameters = {'Mix':Parameter(float, 0, 0.5, .1)}
