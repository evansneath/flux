...
class StandardOverdrive(AudioEffect):
    """Standard Overdrive effect

    A simple hard-knee implementation of an overdrive effect with variable
    effect amplification and overdrive sensitivity.

    Parameters:
        Amount      -- The amount of overdrive to apply to the signal. [-]
        Sensitivity -- The amount of the original signal to apply overdrive. [-]
    """
...
class ClassicOverdrive(AudioEffect):
    ...
    Parameters:
        Amount      -- The amount of overdrive to apply to the signal. [-]
        Sensitivity -- The amount of original signal to apply overdrive. [-]
    """
